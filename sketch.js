...
function draw() {
  ...
  res1.collide (solo);
  res1.setCollider ("rectangle", 0, 0, 250, 250);

  res2.collide (solo);
  res2.setCollider ("rectangle", 0, 0, 220, 220);

  res3.collide (solo);
  res3.setCollider ("rectangle", 0, 0, 220, 220);

  res4.collide (solo);
  res4.setCollider ("rectangle", 0, 0, 220, 220);

  res5.collide (solo);
  res5.setCollider ("rectangle", 0, 0, 220, 220);

  nan.collide (solo);
  nan.setCollider ("rectangle", 0, 0, 220, 220);
  ...
  if (frasco.isTouching (res2) || frasco.x <= 100){
    frasco.visible = false;
    resivida -= 20;
  }
